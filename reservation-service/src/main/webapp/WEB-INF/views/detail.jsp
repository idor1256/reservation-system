...
<body>
            ...
            <div>
                <div class="section_visual">
                    ...
                    <div class="group_visual">
                        <div>
                            <div class="container_visual" style="width: 414px;">
                                <ul class="visual_img">
                                    <c:forEach items="${product_info.images}" var="image">
                                      <li class="item" style="width: 414px;"> <img alt="" class="img_thumb" src="/file/${image.file_id}"> <span class="img_bg"></span>
                                          <div class="visual_txt">
                                              <div class="visual_txt_inn">
                                                  <h2 class="visual_txt_tit">
                                                    <span>${product_info.product.name}</span>
                                                  </h2>
                                                  <p class="visual_txt_dsc">${product_info.product.description}</p>
                                              </div>
                                          </div>
                                      </li>
                                    </c:forEach>
                    ...
                    <div class="group_btn_goto">
                      <a class="btn_goto_home" title="홈페이지" href="${product_info.display_info.homepage}" target="siteUrl"> <i class="fn fn-home1"></i> </a>
                      <a class="btn_goto_tel" title="전화" href="tel:${product_info.display_info.tel}"> <i class="fn fn-call1"></i> </a>
					            <a class="btn_goto_mail" title="이메일" href="mailto:${product_info.display_info.email}"> <i class="fn fn-mail1"></i> </a>
    ...
    <script id="comment-list" >
      <li class="list_item" type="text/x-handlebars-template">
          <div>
              <div class="review_area no_img">
                  <h4 class="resoc_name">{{product_name}}</h4>
                  <p class="review">{{comment}}</p>
              </div>
              <div class="info_area">
                  <div class="review_info"> <span class="grade">{{score}}</span> <span class="name">{{user_name}}</span> <span class="date">{{create_date}}</span> </div>
              </div>
          </div>
      </li>
    </script>
